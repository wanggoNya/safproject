                ...
                <div>
                    <div id="findTypeRdoBoxParent" style="border-top:1px solid gray">
                        <div id="findTypeRdoBox" class="findTypeRdoBox">
                              <span class="pr10 roundRdo"><input id="findByMobile" type="radio" name="searchFindType" value="FindByMobile" checked="checked" onclick="location.href='idform.html'"><label for="findByMobile">휴대폰번호로 찾기</label></span>
                            <span class="roundRdo"><input id="findByEMail" type="radio" name="searchFindType" value="FindByEMail" onclick="location.href='id_emailform.html'"><label for="findByEMail">이메일로 찾기</label></span>
                        </div>
                    </div>
